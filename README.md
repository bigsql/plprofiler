...
3. [Examples](doc/examples.md)
    1. [Executing SQL using the plprofiler utility](doc/examples.md#executing-sql-using-the-profiler-utility)
...
Please see the example [Executing SQL using the plprofiler utility](doc/examples.md#executing-sql-using-the-profiler-utility) for more details about this interactive report.
